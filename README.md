...
See `example_predicates.md` for the worked derivation of every rule above. The **whole-language grammar** — declarations, statements, and value expressions — is `grammar.md`, which incorporates this section's predicate grammar by reference and generalizes its `expr` to full value expressions.
