...
- **[OQ42](questions/OQ42-domain-derivation-trust.md)** — trusting the domain derivation: soundness audit (the symmetric-evaluation argument, body-side `correlatable`), the property-style commutation sweep, the A5 advisory-vs-required dial · born from OQ40's settlement; rides the OQ15/OQ16 calibration campaign
