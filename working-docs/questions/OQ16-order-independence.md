...
**Status:** open — calibration; the hard cases are data-dependent, where fail-closed rejects legitimate specs
...
**See:** README §12, §15 · checks.md V15–V16 · patterns.md "A cascade, concretely" (the transaction shape this question reasons about) · OQ15 (the between-transactions sibling of this question)
